...
/**
 * @ORM\Entity
 * @ORM\Table(name="hoso__phan_bo__180825")
 */
class PhanBo180825  {
	/**
	 * ID_REF
	...
	public function diemDanh(DiemChuyenCan $dcc, PhanBo180825 $phanBoTN, \DateTime $targetDate, $type) {
...
//				$manager->persist();
	...
	public function quanLy(PhanBo180825 $phanBo) {
		/** @var TruongPhuTrachDoi $truongPT */
		foreach($this->cacTruongPhuTrachDoi as $truongPT) {
	...
	/**
	 * @param PhanBo180825 $phanBoTruoc
	 */
