...
//                    'view_tos' => array('template' => '::admin/product/tos.html.twig')
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $formMapper->add('tinhDiemThu5')->add('chiaDeuDiemCCchoNgayCN');
        ...
        $formMapper->add('phieuCNBoSung', ChoiceType::class, array(
            'label' => 'list.label_phieu_bo_sung',
            'multiple' => true,
            'placeholder' => 'Chọn tháng bổ sung phiếu',
            'choices' => [
                'Phiếu Lễ T5' => '5',
                'Phiếu lễ T6' => '6',
            ],
